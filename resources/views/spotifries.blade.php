...
<body >
  ...
  <div class="container">
    <h1>Welcome to Spotifries</h1>

    {{-- TODO: add dynamic search filter --}}
    <form action="/song" method="GET">

      <label for="search" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Song</label>
